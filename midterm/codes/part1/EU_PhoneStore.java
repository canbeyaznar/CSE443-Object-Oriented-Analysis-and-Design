/**
 * @author Can BEYAZNAR
 * We will take phone orders that are included with this class of EUROPE
 */
public class EU_PhoneStore extends PhoneStore{

    /**
     *
     * @param item phone model
     * @return returns phone that customer wants (for EU phone store)
     */
    @Override
    protected Phone createPhone(String item) {
        Phone phone = null;
        PhoneHardwareFactory phonefactory = new EU_HardwareFactory();
